      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-600 via-brand-500 to-accent-500 relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center px-12 xl:px-20">
          <Link href="/" className="flex items-center gap-3 mb-12">
            <div className="w-12 h-12 rounded-2xl bg-white/20 backdrop-blur flex items-center justify-center text-white font-heading font-black text-xl">G</div>
            <span className="font-heading font-bold text-2xl text-white">ESL <span className="text-accent-200">Guliston</span></span>
          </Link>
          <h2 className="font-heading text-4xl font-bold text-white leading-tight mb-4">Learn English<br />the fun way</h2>
          <p className="text-brand-100 text-lg leading-relaxed mb-8">Structured courses, fun activities and progress tracking for all levels.</p>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-white">10</div>
              <div><p className="text-white font-medium text-sm">Activity types</p><p className="text-brand-200 text-xs">MCQ, memory, hangman, matching...</p></div>
            </div>
            <div className="flex items-center gap-3">
      ...
      <div className="flex-1 flex flex-col bg-gradient-to-br from-slate-50 to-white">
        <div className="p-6 lg:hidden">
          <Link href="/" className="flex items-center gap-2 w-fit">
            ...
            <span className="font-heading font-bold text-brand-800">ESL <span className="text-accent-500">Guliston</span></span>
          </Link>
        </div>
