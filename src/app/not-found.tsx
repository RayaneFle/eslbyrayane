    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 via-white to-accent-50">
      <div className="text-center px-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          ...
          <Link href="/cours" className="px-6 py-3 bg-white border border-slate-200 text-slate-700 font-semibold rounded-xl hover:bg-slate-50 transition-all">Browse courses</Link>
        </div>
      </div>
    </div>
  );
