      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-brand-100 p-6">
          ...
          <form onSubmit={changePw} className="space-y-3">
            ...
            <button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-brand-500 to-accent-500 text-white py-2.5 rounded-xl font-semibold hover:shadow-glow disabled:opacity-50 transition-all">{loading ? "Editing…" : "Edit"}</button>
          </form>
        </div>
      </div>
    </div>
