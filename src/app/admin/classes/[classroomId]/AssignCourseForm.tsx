...
export default function AssignCourseForm({ classroomId, courses }: { classroomId: string; courses: { id: string; title: string; level: string }[] }) {
  ...
  return (
    <div className="flex gap-2">
      ...
      <a href="/admin/cours/creer" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-amber-50 text-amber-700 text-sm font-semibold rounded-xl hover:bg-amber-100">Create</a>
    </div>
  );
}
