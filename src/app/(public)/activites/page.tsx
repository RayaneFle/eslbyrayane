    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex items-center justify-between mb-10">
        <div>
          ...
          <p className="text-brand-400 mt-2 text-lg">Practice with our games</p>
        </div>
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Pill href={`/activites${level ? `?level=${level}` : ""}`} active={!type}>All</Pill>
      ...
      {activities.length === 0 ? (
        <div className="text-center py-20 bg-white rounded-2xl border border-brand-100"><span className="text-5xl">🎮</span><p className="text-brand-400 mt-4 text-lg">No activities.</p></div>
      ) : (
