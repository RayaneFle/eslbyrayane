  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-10">
        ...
        <p className="text-brand-400 mt-2 text-lg">Browse our courses by CEFR level</p>
      </div>

      <div className="flex flex-wrap items-center gap-2 mb-8">
        <Link href="/cours" className={`px-4 py-2 rounded-full text-sm font-semibold transition-all ${!level ? "bg-gradient-to-r from-brand-500 to-accent-500 text-white shadow-glow" : "bg-white text-brand-500 border border-brand-200 hover:border-brand-300"}`}>All</Link>
        {levels.map(l => (
